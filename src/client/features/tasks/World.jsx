...
function App() {
  return (
    <div>
      ...
      <img src={SouthAmerica1} className="continent" style={{ width: '900px', position: 'fixed',  left: 10, top: 350,    }}/>
      <img src={Europe1} className="continent" style={{ width: '880px', height: 'auto', position: 'fixed', right: 580, top: 65,  }}/>
      ...
      <img src={Africa1} className="continent" style={{ width: '850px', height: 'auto', position: 'fixed', right: 500, top: 500,  }}/>
        <img src={Austrilia1} className="continent" style={{ width: '600px', height: 'auto', position: 'fixed', right: 200, top: 700,  }}/>
    </div>
  );
}
